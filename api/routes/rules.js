...
router.post("/symptom", requireAuth, (req, res) => {
...
// delete issue
router.delete("/issue/:id", requireAuth, (req, res) => {
...
// delete symptom
router.delete("/symptom/:id", requireAuth, (req, res) => {
...
router.put("/issue/:id", requireAuth, (req, res) => {
  const { issue, symptoms } = req.body;
...
// update symptom
router.put("/symptom/:id", requireAuth, (req, res) => {
  const { symptom, issues } = req.body;
